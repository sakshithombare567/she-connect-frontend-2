          ...
          <div className="space-y-8">
            {blogs.length === 0 ? (
              ...
              blogs.map((blog) => (
                <div
                  key={blog.blog_id}
                  className="glass p-8 md:p-10 rounded-[40px] shadow-lg hover:shadow-xl transition-all group overflow-hidden relative hover:-translate-y-0.5"
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-4 mt-6 text-sm font-bold" style={{ color: 'var(--color-text-secondary)' }}>
